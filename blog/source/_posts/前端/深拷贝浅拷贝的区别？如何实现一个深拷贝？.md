...
function deepCopy(obj){
  if(obj == null) return obj; // undefined null直接返回
  if(typeof obj !== "object") return obj; // 简单类型直接返回
  if(obj instanceof Date) return obj; // 日期对象直接返回
  if(obj instanceof RegExp) return obj; // 正则对象直接返回
